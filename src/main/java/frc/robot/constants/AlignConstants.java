...
public class AlignConstants {
  ...
  public static final double reefDistance23 = Units.inchesToMeters(25);
  public static final double reefDistance4 = Units.inchesToMeters(26);

  public static final double leftAlign = Units.inchesToMeters(-2);
  public static final double rightAlign = Units.inchesToMeters(2);
