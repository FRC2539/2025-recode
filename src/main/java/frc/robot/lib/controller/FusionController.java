...
public class FusionController {
  ...
  public Trigger getBottomLeftPaddle() {
    return getLeftJoystick();
  }

  public Trigger getBottomRightPaddle() {
    return getRightJoystick();
  }

  public Trigger getTopLeftPaddle() {
    return getDPadUpLeft();
  }

  public Trigger getTopRightPaddle() {
    return getDPadUpRight();
  }

  public Trigger getLeftTriggerPressed() {
    return new Trigger(() -> leftTriggerAxis.getAsDouble() > 0.7);
  }
