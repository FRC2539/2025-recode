...
//       new LoggedNetworkBoolean("Lights Timer Warnings", false);
...
//             getJoystickCardinal(opControllerLeftX.getAsDouble(),
// opControllerLeftY.getAsDouble());
//         switch (dir) {
//           case North:
//             rainbow();
//             break;
...
//         cardinalDirection dir =
//             getJoystickCardinal(opControllerRightX.getAsDouble(),
// opControllerRightY.getAsDouble());
//         switch (dir) {
//           case North:
//             matchProgress();
//             break;
...
//           candle.setLEDs(
//               color.red, color.green, color.blue, 0, currentLocation - (-delta), (-delta));
//         }
//       } else {
//         int currentLocation =
//             segment.startIndex
...
//           // Turn on backwards
//           Color color = segment.progressOnColor;
//           candle.setLEDs(color.red, color.green, color.blue, 0, currentLocation - delta + 1,
// delta);
//         } else {
//           // Turn off forwards
//           Color color = segment.progressOffColor;
...
//       value = Math.max(alignToleranceMin, Math.min(alignToleranceMax, value)) -
// alignToleranceMin;
...
//       setAnimation(new FireAnimation(1, speed, segmentSize, 0.5, 0.15, reverseMode, startIndex));
//     }

//     public void setTwinkleAnimation(Color color, double speed, TwinklePercent percent) {
//       setAnimation(
...
//         Color color, double speed, TwinkleOffAnimation.TwinkleOffPercent divider) {
//       setAnimation(
